...
import api from "api";
import { createAppointment } from "api/VirtualClinicRedux/apiUrls"; // Import your api url here
import {
...
export const createAppointmentAction = (requestBody?: any) => async (dispatch: Dispatch) => {
  try {
