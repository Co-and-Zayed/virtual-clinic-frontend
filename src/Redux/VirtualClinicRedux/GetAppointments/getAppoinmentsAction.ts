...
import api from "api";
import { getAppointments } from "api/VirtualClinicRedux/apiUrls"; // Import your api url here
import {
...
export const getAppointmentsAction = (requestBody?: any) => async (dispatch: Dispatch) => {
  try {
