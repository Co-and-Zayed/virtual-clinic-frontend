import styles from "Pharmacy/screens/LoginScreen/LoginScreen.module.css";
...
import Patient from "Pharmacy/assets/images/Patient.svg";
import PharmacistRegisterScreen from "../RegisterScreens/PharmacistRegisterScreen/PharmacistRegisterScreen";
import PatientRegisterScreen from "../RegisterScreens/PatientRegisterScreen/PatientRegisterScreen";
import SubmitButton from "Pharmacy/components/SubmitButton/SubmitButton";
import InputField from "Pharmacy/components/InputField/InputField";
...
const LoginScreen = () => {
        ...
        <div className="w-[40rem] flex flex-col">
          ...
          <div className="flex justify-between flex-1">
            ...
            >
              ...
              />
              <h1 className={styles.h1}>Pharmacist</h1>
  ...
  function renderPharmacist() {
    return <PharmacistRegisterScreen backFn={() => setPage("login")} />;
  }

  function renderPatient() {
    return <PatientRegisterScreen backFn={() => setPage("login")} />;
  }
  ...
  return (
    ...
    >
      ...
      {/* Horizontal footer with "Pharmacy" in the center */}
      <div
      ...
      >
        ...
        />
        <p className={`${styles.greenText} px-6 greenText`}>Pharmacy</p>
        <div
          className="w-full h-[1.25px]"
          style={{ backgroundColor: "var(--light-green)" }}
        />
