...
import api from "api";
import { addFamilyMember } from "api/VirtualClinicRedux/apiUrls"; // Import your api url here
import {
...
export const addFamilyMemberAction = (requestBody?: any) => async (dispatch: Dispatch) => {
  try {
