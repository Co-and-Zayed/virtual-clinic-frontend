import {
  ...
  export const viewSubscribedPackageForFamilyMemberReducer = (state = initialState, action: any) => {
    switch (action.type) {
      case VIEW_SUBSCRIBED_PACKAGE_FOR_FAMILY_MEMBER_DATA_LOADING:
        return { ...state, viewSubscribedPackageForFamilyMemberLoading: action.payload };
