...
interface PharmacistRegisterProps {
  backFn: () => void;
}

const PharmacistRegisterScreen: FC<PharmacistRegisterProps> = ({ backFn }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: PharmacistRegisterModel) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <p className="text-xl font-bold greenText">Pharmacist</p>
      </div>
      <form
...
export default PharmacistRegisterScreen;
