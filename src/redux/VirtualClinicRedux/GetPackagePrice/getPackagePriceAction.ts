...
import api from "api";
import { viewPackagePrice } from "api/VirtualClinicRedux/apiUrls"; // Import your api url here
import {
...
export const viewPackagePriceAction = (requestBody?: any) => async (dispatch: Dispatch) => {
  try {
    ...
    dispatch({ type: VIEW_PACKAGE_PRICE_DATA_SUCCESS, payload: response.data });
  } catch (err) {
